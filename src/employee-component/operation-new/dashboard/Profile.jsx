...
import { Users, Mail, MapPin, Calendar, Link as LinkIcon, Edit, Save, X } from 'lucide-react';
        ...
        <div className="pt-20 px-8 pb-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            {profile.stats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-all duration-300 hover:scale-105"
              >
